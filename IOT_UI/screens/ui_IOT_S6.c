...
{
    ui_IOT_S6 = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_IOT_S6, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_IOT_S6, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_IOT_S6, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_IMG_S5_BG = lv_img_create(ui_IOT_S6);
    ...
    ui_IMG_Ok_1 = lv_img_create(ui_IOT_S6);
    ...
    ui_IMG_Ok_2 = lv_img_create(ui_IOT_S6);
    ...
    ui_Label_Succesful = lv_label_create(ui_IOT_S6);
    ...
    lv_label_set_text(ui_Label_Succesful, "Add and Conect to Device\nSuccesfully!");
    ...
    ui_Label_press_contimue = lv_label_create(ui_IOT_S6);
    ...
    lv_label_set_text(ui_Label_press_contimue, "Press to back home");
    ...
    ui_BTN_Next_2 = lv_obj_create(ui_IOT_S6);
    ...
    lv_obj_add_event_cb(ui_IOT_S6, ui_event_IOT_S6, LV_EVENT_ALL, NULL);
